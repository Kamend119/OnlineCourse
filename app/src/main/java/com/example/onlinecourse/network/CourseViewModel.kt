...
class AppealTopicViewModel : ViewModel() {
    ...
    fun addTopic(name: String, description: String) {
        viewModelScope.launch {
            isLoading = true
            try {
                operationResult = RetrofitClient.instance.addTopicAppeal(name, description)
                errorMessage = null
    ...
    fun updateTopic(id: Long, name: String, description: String) {
        viewModelScope.launch {
            isLoading = true
            try {
                operationResult = RetrofitClient.instance.updateTopicAppeal(id, name, description)
                errorMessage = null
                if (operationResult == true) loadTopics()
            } catch (e: Exception) {
    ...
    fun deleteTopic(id: Long) {
        viewModelScope.launch {
            isLoading = true
            try {
                operationResult = RetrofitClient.instance.deleteTopicAppeal(id)
                errorMessage = null
                if (operationResult == true) loadTopics()
            } catch (e: Exception) {
...
class CourseCategoryViewModel : ViewModel() {
    ...
    fun addCategory(name: String, description: String) {
        viewModelScope.launch {
            isLoading = true
            try {
                operationResult = RetrofitClient.instance.addCourseCategory(name, description)
                errorMessage = null
    ...
    fun updateCategory(courseId: Long, name: String, description: String) {
        viewModelScope.launch {
            isLoading = true
            try {
                operationResult = RetrofitClient.instance.updateCourseCategory(courseId, name, description)
                errorMessage = null
                if (operationResult == true) loadCategories()
            } catch (e: Exception) {
    ...
    fun deleteCategory(courseId: Long) {
        viewModelScope.launch {
            isLoading = true
            try {
                operationResult = RetrofitClient.instance.deleteCourseCategory(courseId)
                errorMessage = null
                if (operationResult == true) loadCategories()
            } catch (e: Exception) {
